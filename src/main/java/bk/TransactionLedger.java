...
public class TransactionLedger extends LedgerWindow implements ChangeListener {
  ...
  private void plotShareInfo(String prompt, int y, ShareCalc c) {
  ...
  private StockCalculator mCalc;

  private void calcShareStuff() {
    var c = new StockCalculator();
    //
    c.withAccountNumber(mAccountNumber);

    var cr = getCurrentRow();
