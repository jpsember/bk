...
public final class Util {
  ...
  public static JSMap db(Object obj) {
    var m = map();
    if (obj == null)
      m.put("", "NULL");
    else {
  ...
  public static long uniqueTimestamp() {
    var ts = sNextUniqueTimestamp++;
    return ts;
  }

  public static void adjustUniqueTimestamp(long t) {
    if (t >= sNextUniqueTimestamp) {
      sNextUniqueTimestamp = t + 1;
      pr("...bumped unique timestamp to:", sNextUniqueTimestamp);
    }
  }

  public static void adjustUniqueTimestamp(Collection<Transaction> tr) {
    for (var t : tr)
      adjustUniqueTimestamp(t.timestamp());
  }

  private static long sNextUniqueTimestamp = System.currentTimeMillis();
  ...
  private static DFA descDFA() {
    if (sDescDFA == null) {
      var rxp = Files.readString(Util.class, "desc.dfa");
      sDescDFA = DFA.parse(rxp);
